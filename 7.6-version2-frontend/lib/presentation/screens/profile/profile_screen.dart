      ...
      children: [
        ...
        _buildSection(
          ...
          children: [
            ...
            _buildInfoRow('Daily Calories', _userProfile!['dailyCaloriesTarget'] != null ? '${(_userProfile!['dailyCaloriesTarget']).round()} kcal' : 'N/A'),
            _buildInfoRow('Daily Protein', _userProfile!['dailyProteinTarget'] != null ? '${(_userProfile!['dailyProteinTarget']).round()} g' : 'N/A'),
            _buildInfoRow('Daily Carbs', _userProfile!['dailyCarbTarget'] != null ? '${(_userProfile!['dailyCarbTarget']).round()} g' : 'N/A'),
            _buildInfoRow('Daily Fat', _userProfile!['dailyFatTarget'] != null ? '${(_userProfile!['dailyFatTarget']).round()} g' : 'N/A'),
            _buildInfoRow('Sugar Limit', _dailySugarGoal != null ? '${_dailySugarGoal!.round()} g' : 'N/A'),
            SizedBox(height: 12),
            _buildSettingsTile(
              icon: Icons.tune,
              title: 'Nutrition Goals Setting',
              subtitle: 'Set and adjust your daily nutrition targets',
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => const ComprehensiveNutritionGoalsPage(),
                  ),
                ).then((_) {
                  // 返回时刷新用户配置文件以显示更新的营养目标
                  _loadUserProfile();
                });
              },
            ),
