...
class RecommendationEngine:
    ...
    async def _generate_receipt_insights(self, purchased_products: List[Dict],
        ...
        try:
            ...
            if llm_response.success:
                ...
                return {
                    "summary": "Your shopping habits show high sugar content and unhealthy dietary patterns affecting weight loss goals",
                    "key_insights": [
                        "Overall sugar content is too high in purchased items",
                        "Nutritional balance needs improvement"
                    ],
                    "improvement_suggestions": [
                        "Consider choosing lower sugar alternatives",
                        "Increase protein intake for better nutrition"
                    ],
            ...
            logger.error(f"Receipt insights generation failed: {e}")
            # Return fallback analysis in English
            return {
                "summary": "Your purchased items show high sugar content and unbalanced nutrition affecting your health goals",
                "key_insights": [
                    "High sugar content detected across multiple products",
                    "Nutritional structure is unbalanced"
                ],
                "improvement_suggestions": [
                    "Choose low-sugar alternatives for better health",
    ...
    async def _generate_detailed_recommendation_reasoning(self, scored_product: Dict, 
        ...
        try:
            ...
            detailed_reasoning_prompt = f"""You are Grocery Guardian, a caring nutrition advisor who knows the user personally. Write a warm, personalized recommendation for this product alternative.
...
Write EXACTLY 4 sections with concise, personal language. Each section should be 2-3 sentences maximum. Use a caring tone like "Based on your activity level..." or "I noticed that..." or "Since you're working towards..."

Structure:
### [Emoji] [Personal Title]
[2-3 concise sentences explaining this benefit in a warm, personal way]

### [Emoji] [Different Personal Title] 
[2-3 concise sentences from a different nutritional angle]

### [Emoji] [Third Personal Title]
[2-3 concise sentences focusing on yet another aspect]

### 💡 Personal Suggestion
[2-3 concise sentences with practical advice for their lifestyle]

Example tone and titles:
- 💪 Perfect for Your Active Routine
- 🌟 Better Fuel for Your Goals  
- ⚡ Why This Works for You
- 🎯 Tailored to Your Lifestyle
- 🔥 Supporting Your Journey
- 🏃 Made for Your Energy Needs
- 💫 A Smarter Choice for You

Write as if you're a knowledgeable friend who cares about their health. Be warm, specific, and avoid technical jargon. Use personal language like "your", "you're", "I see", "based on what I know about you."

IMPORTANT: Keep each section to 2-3 sentences maximum. Be concise but personal. Focus on key benefits only.

Formatting tips:
- Use **bold** for key nutritional benefits or important numbers
- Use **bold** for action words like "boost", "support", "enhance" 
