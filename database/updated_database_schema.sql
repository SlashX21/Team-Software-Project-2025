...
CREATE TABLE PRODUCT (
    bar_code VARCHAR(255) PRIMARY KEY COMMENT 'Product unique identifier - supports up to 255 characters',
    product_name VARCHAR(250) NOT NULL COMMENT 'Product name - supports longer names',
    ...
    INDEX idx_name_search (product_name(50)),
...
CREATE TABLE USER (
    ...
    user_name VARCHAR(50) UNIQUE NOT NULL COMMENT 'Username',
    ...
    activity_level VARCHAR(50) COMMENT 'Activity level',
    nutrition_goal VARCHAR(50) COMMENT 'Nutrition goal',
    ...
    created_time VARCHAR(50) COMMENT 'Create time as string',
...
CREATE TABLE ALLERGEN (
    ...
    name VARCHAR(100) NOT NULL COMMENT 'Allergen standard name',
...
CREATE TABLE PRODUCT_ALLERGEN (
    ...
    bar_code VARCHAR(255) NOT NULL COMMENT 'Product barcode - matches PRODUCT.bar_code',
    allergen_id INT NOT NULL COMMENT 'Allergen ID',
    ...
    FOREIGN KEY (allergen_id) REFERENCES ALLERGEN(allergen_id) ON DELETE CASCADE,
    UNIQUE KEY uk_product_allergen (bar_code, allergen_id),
    INDEX idx_allergen_presence (allergen_id, presence_type),
    INDEX idx_barcode_allergen (bar_code)
...
CREATE TABLE SCAN_HISTORY (
    ...
    INDEX idx_barcode_scans (bar_code)
...
CREATE TABLE PURCHASE_ITEM (
    ...
    FOREIGN KEY (bar_code) REFERENCES PRODUCT(bar_code) ON DELETE CASCADE,
    INDEX idx_purchase_item (purchase_id, bar_code),
    INDEX idx_purchase_quantity_weight (purchase_id, bar_code, quantity),
...
CREATE TABLE PRODUCT_PREFERENCE (
    ...
    FOREIGN KEY (user_id) REFERENCES USER(user_id) ON DELETE CASCADE,
    FOREIGN KEY (bar_code) REFERENCES PRODUCT(bar_code) ON DELETE CASCADE,
    UNIQUE KEY uk_user_product_preference (user_id, bar_code),
...
CREATE TABLE RECOMMENDATION_LOG (
    ...
    user_id INT NOT NULL COMMENT 'User ID',
    request_barcode VARCHAR(255) COMMENT 'Original product barcode - matches PRODUCT.bar_code',
