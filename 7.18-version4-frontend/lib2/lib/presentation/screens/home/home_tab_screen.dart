...
import '../product/product_recommendation_page.dart';
...
class _HomeTabScreenState extends State<HomeTabScreen> {
  ...
  Widget _buildNutritionGoalsCard(BuildContext context) {
    return GestureDetector(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => ComprehensiveNutritionGoalsPage(),
          ),
        );
      },
      child: Container(
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 4),
                  Text('Set and track your nutrition goals', style: AppStyles.bodyRegular.copyWith(color: AppColors.textLight)),
                ],
              ),
            ),
            Icon(Icons.arrow_forward_ios, color: AppColors.textLight, size: 18),
  ...
  Widget _buildProductRecommendationCard(BuildContext context) {
    return GestureDetector(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => ProductRecommendationPage(),
          ),
        );
      },
      child: Container(
        ...
        child: Row(
          children: [
            Icon(Icons.recommend, color: AppColors.success, size: 32),
            SizedBox(width: 16),
            Expanded(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text('Product Recommendations', style: AppStyles.bodyBold),
                  SizedBox(height: 4),
                  Text('Discover healthier product choices', style: AppStyles.bodyRegular.copyWith(color: AppColors.textLight)),
                ],
              ),
            ),
            Icon(Icons.arrow_forward_ios, color: AppColors.textLight, size: 18),
