...
class ReceiptHistoryService {
  ...
  /// [month] - Optional month filter in YYYY-MM format (e.g., "2025-07")
  /// 
  ...
  Future<PagedResponse<ReceiptHistoryItem>> getReceiptHistory({
    ...
    try {
      ...
      if (month != null) {
        ...
        print('🔍 Receipt API call with month filter: $month');
      } else {
        print('⚠️ Receipt API call WITHOUT month filter');
      }
      
      final uri = Uri.parse('$baseUrl/api/receipt-history')
          .replace(queryParameters: queryParams);
      
      print('🌐 Receipt API URL: $uri');
