...
// --- Responsive Spacing System (8dp grid with screen adaptation) ---
class DSSpacings {
  DSSpacings._();

  // Base spacing values (will be scaled based on screen size)
  ...
  // Responsive spacing getters (use these for automatic adaptation)
  static double get adaptiveXXS => xxs;  // Keep small spacings fixed
  static double get adaptiveXS => xs;    // Keep small spacings fixed
  static double get adaptiveS => s;      // Use extension methods: 16.r
  static double get adaptiveM => m;      // Use extension methods: 24.r
  static double get adaptiveL => l;      // Use extension methods: 32.r
  static double get adaptiveXL => xl;    // Use extension methods: 48.r
  static double get adaptiveXXL => xxl;  // Use extension methods: 64.r
}
