...
class _ProfileSetupScreenState extends State<ProfileSetupScreen> {
  ...
  final List<String> _nutritionGoals = [
    'WEIGHT_LOSS',
    'WEIGHT_GAIN',
    'MUSCLE_GAIN',
    'MAINTENANCE',
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          ..._nutritionGoals.map((goal) => _buildGoalOption(goal)),
        ],
      ),
    );
  }
  ...
  Widget _buildGoalOption(String goal) {
    final isSelected = _selectedNutritionGoal == goal;
    
    return GestureDetector(
      onTap: () => setState(() => _selectedNutritionGoal = goal),
      child: Container(
        margin: EdgeInsets.only(bottom: 12),
        padding: EdgeInsets.all(16),
        decoration: BoxDecoration(
  ...
  bool _canProceed() {
    switch (_currentStep) {
      ...
      case 2:
        return _selectedNutritionGoal != null;
      default:
        return false;
    }
  }
